...
const createTableSqlListSqlite = [
  ...
  `INSERT OR IGNORE INTO storage (storage_id, name, type, sort, status) VALUES ('local', 'local storage', 1, 0, 0)`,
  `CREATE TABLE IF NOT EXISTS setting (
        key TEXT PRIMARY KEY,
        value TEXT NOT NULL
    )`,
  `INSERT OR IGNORE INTO setting (key, value) VALUES ('${SETTING_KEY}', '${JSON.stringify(settingDefaults)}')`,
